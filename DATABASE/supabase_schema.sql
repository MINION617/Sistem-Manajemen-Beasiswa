...
-- dokumen_mahasiswa: profile-stage uploads (the standard package, D-08),
-- owned by the student and reused across all their applications.
...
-- dokumen_mahasiswa: student owns their own; staff/kabag read.
