...
function initParticles() {
  ...
  if (!container) return;
  const icons = [
    ['solar:banknote-bold-duotone','rgba(124,58,237,.20)'],
    ['solar:transfer-horizontal-bold-duotone','rgba(37,99,235,.18)'],
    ['solar:card-transfer-bold-duotone','rgba(124,58,237,.18)'],
    ['solar:check-circle-bold-duotone','rgba(5,150,105,.18)'],
    ['solar:wallet-money-bold-duotone','rgba(124,58,237,.16)'],
    ['solar:dollar-minimalistic-bold-duotone','rgba(37,99,235,.16)'],
  ];
  for (let i=0;i<18;i++) {
